...
const socialMediaLinks = {
  github: "https://github.com/om-chor",
  linkedin: "https://in.linkedin.com/in/om-agarwal-7b9444374",
  gmail: "agarwalom20@gmail.com",
...
const skillsSection = {
  ...
  skills: [
    emoji(
        "🤖 Helping developers build efficient, well-structured, and scalable code."

    ),
    emoji("💡 Assisting with problem-solving, debugging, and learning new technologies."),
    emoji(
        "🌐 Integrating AI and natural language understanding to enhance user experience."
  ...
  schools: [
    {
      ...
      subHeader: "Batchlors in Science (Information Technology)",
      duration: " 2021 - 2024",
...
//      ]
    ...
    {
      schoolName: "Guru Nanak Institute of Managemental Studies",
     // logo: require("./assets/images/stanfordLogo.png"),
      subHeader: "Masters in Computer Application",
      duration: "2024 - 2026",
      desc: "Currently Persuing",
...
const techStack = {
  ...
  experience: [
    {
      Stack: "Database Management", //Insert stack or technology you have experience in
...
const contactInfo = {
  ...
  number: "+91-7303607801",
  email_address: "agarwalom20@gmail.com"
};
